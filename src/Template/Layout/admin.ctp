...
<html>
    <head>
        ...
        <title>
            <title>Admin | Thế giới truyện</title>
            <?= $this->fetch('title') ?>
        </title>
        <?= $this->Html->meta('icon') ?>
        ...
        <!-- bootstrap 3.0.2 -->
        <?= $this->Html->css('admin_css/bootstrap.min.css') ?>
        <?= $this->Html->css('admin_css/font-awesome.min.css') ?>
        <?= $this->Html->css('admin_css/ionicons.min.css') ?>
        <?= $this->Html->css('admin_css/morris/morris.css') ?>
        <?= $this->Html->css('admin_css/jvectormap/jquery-jvectormap-1.2.2.css') ?>
        <?= $this->Html->css('admin_css/fullcalendar/fullcalendar.css') ?>
        <?= $this->Html->css('admin_css/daterangepicker/daterangepicker-bs3.css') ?>
        <?= $this->Html->css('admin_css/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') ?>
        <?= $this->Html->css('admin_css/AdminLTE.css') ?>
        
        <?= $this->Html->script('jquery-1.10.0.min.js') ?>
        <?= $this->Html->script('bootstrap.min.js') ?>
        <?= $this->Html->script('admin_js/plugins/morris/morris.min.js') ?>
        <?= $this->Html->script('admin_js/plugins/sparkline/jquery.sparkline.min.js') ?>

        <?= $this->Html->script('admin_js/AdminLTE/app.js') ?>
        <?= $this->Html->script('admin_js/AdminLTE/dashboard.js') ?>
        <?= $this->Html->script('admin_js/AdminLTE/demo.js') ?>
